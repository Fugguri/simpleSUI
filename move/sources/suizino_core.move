module coinflipper::Suizino_core {
    // Part 1: imports
    ...
    fun init(ctx: &mut TxContext) {
        ...
        transfer::share_object(Casino {
            id: object::new(ctx),
            name: string::utf8(b"SimpleSui"),
            description: string::utf8(b"Small Lucky Wheel "),
            cost_per_game: 5000,
    ...
    public entry fun gamble(casino: &mut Casino, wallet: &mut Coin<SUI>, ctx: &mut TxContext){
        ...
        if(slot_1 == slot_2 && slot_2 == slot_3){
            winnings = max_earnings + 5000 ;// calculate winnings + the money the user spent.
    ...
    public entry fun deposit(casino :&mut Casino, amount: u64, payment: &mut Coin<SUI>){
