...
const depositToCasino = async () => {
  ...
  console.log(authStore.casinoAdmin.objectAddress)
    ...
    <div class="grid grid-cols-12 gap-5 py-6 items-center">
      ...
      <div class="col-span-8 justify-self-end flex items-center">
        ...
        <button @click="toggleDark()" class="mr-3">
          <svg v-if="!isDark" id="theme-toggle-dark-icon" class=" w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
          </svg>
          <svg v-if="isDark" id="theme-toggle-light-icon" class=" w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <button v-if="authStore.casinoAdmin.isAdmin"
          class="bg-gray-800 dark:bg-gray-800 flex items-center text-white px-5 py-2 mr-2 rounded-full"
